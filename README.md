...
- Sections with **dynamic content** fetched from an API.
...
```
/components    -> Reusable React components (Slider, Navbar, Hero, etc.)
...
This project is a 100% original portfolio project by Salvador Martínez. No commercial use intended.
